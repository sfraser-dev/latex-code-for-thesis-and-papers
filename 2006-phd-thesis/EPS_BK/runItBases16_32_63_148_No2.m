...
global xlabelTXT_JPG xlabelTXT_NGV xlabelFS ylabelTXT ylabelTXT ylabelFS textFS xval yval axesFS;
xlabelTXT_JPG='JPEG Quality'; xlabelTXT_NGV='Normalised Gaussian Variance'; xlabelFS=16;
ylabelTXT='NC'; ylabelFS=16;
textFS=20;
axesFS=14;

xvalJPG=5; yvalJPG=-0.35; 
xvalWG=0.0015; yvalWG=-0.35; 
xvalSG=0.0065; yvalSG=-0.35; 



xval=xvalJPG; yval=yvalJPG;
...
global xlabelTXT_JPG xlabelFS ylabelTXT ylabelFS textFS xval yval axesFS;
%% Get mat files
...
axes('FontSize',axesFS);
plot(jpgQualStore,theVec);
xlabel(xlabelTXT_JPG,'Fontsize',xlabelFS); ylabel(ylabelTXT,'Fontsize',ylabelFS);
axis([ax1 ax2 ax3 ax4]);
theStr=sprintf('%s: BCH(148,148,1):rep.=3',nameStr);
text(xval,yval,theStr,'FontSize',textFS);
...
global xlabelTXT_NGV xlabelFS ylabelTXT ylabelFS textFS xval yval axesFS;
%% Get mat files
theStr=sprintf('cd %s',theDirStr); eval(theStr); 
...
xlabel(xlabelTXT_NGV,'FontSize',xlabelFS); ylabel(ylabelTXT,'Fontsize',ylabelFS);
axis([ax1 ax2 ax3 ax4]);
...
global xlabelTXT_JPG xlabelFS ylabelTXT ylabelFS textFS axesFS;
global xval yval;
%% Get mat files
theStr=sprintf('cd %s',theDirStr); eval(theStr); 
...
%% Plotting graphs
jpgQualStore=10:5:100;
%xval=20; yval=-0.35;	% Location of text in figure
ax1=0; ax2=100; ax3=-0.5; ax4=1;	% Axis values for plots
