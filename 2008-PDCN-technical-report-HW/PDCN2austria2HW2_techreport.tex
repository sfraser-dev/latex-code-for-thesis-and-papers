...
\title{TECHNICAL REPORT: DESIGN AND SIMULATION OF REAL-TIME IMAGE PROCESSING ALGORITHMS}
%\title{PARALLEL IMAGE PROCESSING TECHNIQUES: DESIGN AND SIMULATION}
%\title{DESIGN AND SIMULATION OF REAL-TIME IMAGE PROCESSING TECHNIQUES FOR HARDWARE}
...
\setlength{\abovecaptionskip}{-0.25cm}
        %\includegraphics[height=2.5cm,width=2.5cm]{pics/win5.pstex}
...
\begin{center}
\setlength{\abovecaptionskip}{-0.25cm}
        \includegraphics[height=1.2cm,width=8.25cm]{pics/cannyFlow2.pstex}
...
\begin{center}
\setlength{\abovecaptionskip}{-0.25cm}
        %\includegraphics[height=7cm,width=8.25cm]{pics/oddEvenSort.pstex}
...
\begin{center}
\setlength{\abovecaptionskip}{-0.25cm}
        %\includegraphics[height=8.25cm,width=8.0cm]{pics/convolution2.pstex}
...
\begin{center}
\setlength{\abovecaptionskip}{-0.25cm}
        \includegraphics[height=4.5cm,width=8.25cm]{pics/histeqLena256.pstex}
...
\begin{center}
\setlength{\abovecaptionskip}{-0.25cm}
        \includegraphics[height=8cm,width=8cm]{pics/gauss11x11cross.pstex}
...
%\label{eq:combSimp}
%\lefteqn{G(r,c) = max(|G_{v}(r,c)|,|G_{h}(r,c)|) +} \\ 
%& \frac{min(|G_{v}(r,c)|,|G_{h}(r,c)|)}{4}
%\begin{eqnarray}
%  10xy^2+15x^2y-5xy & = & 5\left(2xy^2+3x^2y-xy\right) \nonumber \\
%   & = & 5x\left(2y^2+3xy-y\right) \nonumber \\
%   & = & 5xy\left(2y+3x-1\right)
%\end{eqnarray}
% http://www.andy-roberts.net/misc/latex/latextutorial10.html  GOOGLE "latex lefteqn"
\begin{eqnarray}
\label{eq:combSimp}
...
\begin{center}
\setlength{\abovecaptionskip}{-0.25cm}
        \includegraphics[height=4.5cm,width=8.25cm]{pics/lenaGauss11crossSmooth.pstex}
...
\begin{center}
\setlength{\abovecaptionskip}{-0.25cm}
        \includegraphics[width=8cm,height=7cm]{pics/circJustXfig.pstex}
...
\begin{center}
\setlength{\abovecaptionskip}{-0.25cm}
        \includegraphics[width=5cm,height=6cm]{pics/nmsExample.pstex}
...
\begin{center}
\setlength{\abovecaptionskip}{-0.25cm}
        \includegraphics[width=8.25cm,height=8cm]{pics/lenas4Edge.pstex}
...
\begin{center}
\setlength{\abovecaptionskip}{-0.25cm}
        \includegraphics[width=6cm,height=6cm]{pics/hystthEx.pstex}
